# -*- coding: utf-8 -*-
"""IbitingaGaviaoPeixoto-128 pixels - TeseFinalDoutorado(ANN e CNN).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gxPtaSrgVordVBiLSCCkAKPGpk_q53o-
"""
...
data = pd.read_csv('/content/drive/MyDrive/Unicamp/Doutorado/TeseFinal_Dados/IBITINGA GAVIAO PEIXOTO/ANN e CNN/IBITINGA GAVIAO PEIXOTO - Dados para processar rede-CSV.csv', delimiter=';')  # Ajuste o delimitador conforme o arquivo
...
def create_combined_model_with_ann():
    ...
    ann_input = tf.keras.Input(shape=(len(features),))
    dense_layer = Dense(128, activation='relu')(ann_input)
    dense_layer = Dense(64, activation='relu')(dense_layer)
    dense_layer = Dense(32, activation='relu')(dense_layer)
    dense_layer = Dense(16, activation='relu')(dense_layer)

    # Combinar CNN e ANN
    combined = tf.keras.layers.concatenate([cnn_features, dense_layer])
    output = Dense(1, activation='linear')(combined)

    model = tf.keras.Model(inputs=[cnn_input, ann_input], outputs=output)
...
# Criar o modelo combinado com ANN
model = create_combined_model_with_ann()
...
nome_arquivo = f"ResultadosIbitingaGaviaoPeixoto_ANN_CNN_{hoje}.csv"

# Caminho completo no Google Drive
output_path = f'/content/drive/MyDrive/Unicamp/Doutorado/TeseFinal_Dados/IBITINGA GAVIAO PEIXOTO/ANN e CNN/{nome_arquivo}'
